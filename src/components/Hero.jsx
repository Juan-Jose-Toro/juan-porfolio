...
const Hero = ({
    ...
    const charWidth = 10; // 10
    const charHeight = 20; // 20
    ...
    const centerVignetteStyle = {
        ...
        height: '80%',
        pointerEvents: 'none',
        background: 'radial-gradient(circle, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0) 15rem)'
    };

    return (
        <div style={containerStyle} className={className}>
            {/* Title and page buttons */}
            <div className="hero__action-container">
                <div>
                    <h1 className="hero__title">Hi, I'm Juan <br/> a Software Enginner!</h1>
